...
cfg = CustomConfigurator(
   ...
   variables = {
       ...
       "top_mass": HistConf( [Axis(coll="top", field="mass", bins=[0, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1250, 1500, 1750], label="$top_M$")] ),
       "VLT_pt": HistConf( [Axis(coll="VLT", field="pt", bins=[0, 40, 80, 120, 160, 200, 300, 500, 1000], label="$p_T^{VLT}$")] ),
       "VLT_mass": HistConf( [Axis(coll="VLT", field="mass", bins=[0, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1250, 1500, 1750, 2000], label="$VLT_M$")] ),
       "Electron_pt" : HistConf( [Axis(coll="LeptonGood", field="pt", bins=[0, 40, 80, 120, 160, 200, 300, 500, 1000], label="$e_{p_T}$")] ),
